...
namespace SGV_Booking.Models
{
    public partial class Restaurant
    {
        public Restaurant()
        {
            ...
            RestaurantOpenTimes = new HashSet<RestaurantOpenTime>();
        }
        ...
        public virtual RestaurantOpenDay? RestaurantOpenDay { get; set; }
        public virtual ICollection<Banquet> Banquets { get; set; }
        public virtual ICollection<Booking> Bookings { get; set; }
        public virtual ICollection<RestaurantOpenTime> RestaurantOpenTimes { get; set; }
    }
}
