...
INSERT INTO Restaurants (restaurantName, restaurantAddressID, restaurantRewardValue) VALUES('Bamboo Leaf', (SELECT addressID FROM Addresses WHERE addressID = 1), 250);
INSERT INTO Restaurants (restaurantName, restaurantAddressID, restaurantRewardValue) VALUES('La Oeste De La Mar', (SELECT addressID FROM Addresses WHERE addressID = 2), 250);
INSERT INTO Restaurants (restaurantName, restaurantAddressID, restaurantRewardValue) VALUES('Mexikana', (SELECT addressID FROM Addresses WHERE addressID = 3), 250);
...
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, numGuest) VALUES(2, '2023-09-30 19:00:00', (SELECT userID from Users WHERE userID = 10003), 'This is a booking for La Oeste De La Mar at 7:00pm with 3 guests and no banquet', 3);
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, banquetOption, numGuest) VALUES(1, '2023-09-29 18:00:00', (SELECT userID from Users WHERE userID = 10004), 'This is a booking for Bamboo Leaf at 6:00pm with 5 guests and Share Banquet', 1, 5);
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, banquetOption, numGuest) VALUES(3, '2023-09-28 20:00:00', (SELECT userID from Users WHERE userID = 10005), 'This is a booking for Mexikana at 8:00pm with 8 guests and Share Banquet', 3, 8);
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, numGuest) VALUES(2, '2023-09-27 18:30:00', (SELECT userID from Users WHERE userID = 10005), 'This is a booking for La Oeste De La Mar at 6:30pm with 2 guests and no banquet', 2);
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, banquetOption, numGuest) VALUES(1, '2023-09-26 20:30:00', (SELECT userID from Users WHERE userID = 10004), 'This is a booking for Bamboo Leaf at 8:30pm with 4 guests and Feast Banquet', 2, 4);
INSERT INTO Bookings (restaurantID, bookingTime, customerID, bookingNotes, numGuest) VALUES(3, '2023-09-28 19:45:00', (SELECT userID from Users WHERE userID = 10005), 'This is a booking for Mexikana at 7:45pm with 7 guests and no banquet',7);
